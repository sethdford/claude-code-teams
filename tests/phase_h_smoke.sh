...
assert "aggagent.py executable"             "[[ -x $CLAUDE_DIR/rl/aggagent.py ]]"
assert "aggagent imports"                   "python3 -c 'import sys; sys.path.insert(0, \"$CLAUDE_DIR/rl\"); import aggagent'"
assert "best_of_n has synthesize mode"      "python3 $CLAUDE_DIR/rl/best_of_n.py --help 2>&1 | grep -q synthesize"
